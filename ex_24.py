# Напишите программу,
# которая считывает с клавиатуры название футбольной команды и выводит информацию о ней в следующем формате:
#
...
length = len(football_club)

print(f"Футбольная команда {football_club} имеет длину {length} символов")
